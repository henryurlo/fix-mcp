...
Endpoints:
    ...
    GET  /api/mcp/schema     — list MCP tools, resources, and prompts
    GET  /api/prompts/trading-ops — show the active trading-ops prompt
...
from fix_mcp.prompts.trading_ops import SCENARIO_PROMPTS, TRADING_OPS_PROMPT
...
@app.get("/api/prompts/trading-ops")
async def api_trading_ops_prompt():
    """Expose the active trading-ops prompt for demos and MCP-client verification."""
    return PlainTextResponse(TRADING_OPS_PROMPT)
